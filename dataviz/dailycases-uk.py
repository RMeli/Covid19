...
dailycases.rename(columns={"DateVal": "date", "CMODateCount": "new", "CumCases": "total"}, inplace=True)
...
def plotdailycases(yname, log=False, xskyp=2):
    plt.figure()

    sns.barplot(x="date", y=yname, data=dailycases, palette="rocket_r")
